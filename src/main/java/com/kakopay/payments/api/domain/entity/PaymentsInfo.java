...
//    @OneToMany(fetch = FetchType.EAGER, mappedBy = "paymentsInfo")
//    private List<CancelInfo> cancelList = new ArrayList<CancelInfo>();
    @OneToMany(fetch = FetchType.EAGER, cascade = CascadeType.ALL)
    @JoinColumn(name = "manage_id")
    private List<CancelInfo> cancelList;
